...
public class BLEPeripheralHelper {
    ...
    private void advertiseService() {
        ...
        /* KP : setIncludeDeviceName set to false to reduce the data size < 31 bytes */
        AdvertiseData data = new AdvertiseData.Builder()
                .setIncludeDeviceName(false) // Earlier it was true
    ...
    public void startAdvertising() {
        Log.i(TAG, "startAdvertising Line 447");
    ...
    private AdvertiseCallback mAdvertiseCallback = new AdvertiseCallback() {
        ...
        public void onStartFailure(int errorCode) {
            /* Note  : If error code is 1 that means data size exceeds the limit */
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            com.btmap.jankidave.common.logger.Log.d(TAG, "Socket Type: " + mSocketType +
